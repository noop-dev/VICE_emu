...
const ui_menu_entry_t sound_output_menu[] = {
    ...
    { "Buffer size",
      ...
      NULL },
    SDL_MENU_ITEM_SEPARATOR,
    { "Frequency", MENU_ENTRY_TEXT, NULL, (ui_callback_data_t)1 },
    { "22050 Hz",
      MENU_ENTRY_RESOURCE_RADIO,
    ...
    { "Custom frequency",
      ...
      NULL },
    SDL_MENU_ITEM_SEPARATOR,
    { "Oversampling", MENU_ENTRY_TEXT, NULL, (ui_callback_data_t)1 },
    { "None",
      MENU_ENTRY_RESOURCE_RADIO,
      radio_SoundOversample_callback,
    ...
    SDL_MENU_ITEM_SEPARATOR,
    { "Synchronization method", MENU_ENTRY_TEXT, NULL, (ui_callback_data_t)1 },
    { "Flexible",
      MENU_ENTRY_RESOURCE_RADIO,
