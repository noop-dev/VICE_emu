/*
 * asm65CE02.c - 65CE02 Assembler-related utility functions.
 *
 * Written by
...
static const int addr_mode_size[] = {
    ...
    2, /* ASM_ADDR_MODE_INDIRECT_Z */
    3, /* ASM_ADDR_MODE_RELATIVE_LONG */
    4, /* ASM_ADDR_MODE_IMMEDIATE_24 */
...
static const asm_opcode_info_t opcode_list[] = {
    ...
    /* 02 */ { "CLE",   ASM_ADDR_MODE_IMPLIED },
    /* 03 */ { "SEE",   ASM_ADDR_MODE_IMPLIED },
    ...
    /* 12 */ { "ORA",   ASM_ADDR_MODE_INDIRECT_Z },
    /* 13 */ { "BPL",   ASM_ADDR_MODE_RELATIVE_LONG },
    ...
    /* 22 */ { "JSR",   ASM_ADDR_MODE_ABS_INDIRECT },
    /* 23 */ { "JSR",   ASM_ADDR_MODE_ABS_INDIRECT_X },
    ...
    /* 32 */ { "AND",   ASM_ADDR_MODE_INDIRECT_Z },
    ...
    /* 42 */ { "NEG",   ASM_ADDR_MODE_ACCUMULATOR },
    /* 43 */ { "ASR",   ASM_ADDR_MODE_ACCUMULATOR },
    /* 44 */ { "ASR",   ASM_ADDR_MODE_ZERO_PAGE },
    ...
    /* 52 */ { "EOR",   ASM_ADDR_MODE_INDIRECT_Z },
    /* 53 */ { "BVC",   ASM_ADDR_MODE_RELATIVE_LONG },
    /* 54 */ { "ASR",   ASM_ADDR_MODE_ZERO_PAGE_X },
    ...
    /* 5b */ { "TAB",   ASM_ADDR_MODE_IMPLIED },
    /* 5c */ { "AUG",   ASM_ADDR_MODE_IMMEDIATE_24 },
    ...
    /* 62 */ { "RTN",   ASM_ADDR_MODE_IMMEDIATE },
    /* 63 */ { "BSR",   ASM_ADDR_MODE_RELATIVE },
    ...
    /* 72 */ { "ADC",   ASM_ADDR_MODE_INDIRECT_Z },
    /* 73 */ { "BVS",   ASM_ADDR_MODE_RELATIVE_LONG },
    ...
    /* 82 */ { "STA",   ASM_ADDR_MODE_STACK_RELATIVE_Y },
    /* 83 */ { "BRA",   ASM_ADDR_MODE_RELATIVE_LONG },
    ...
    /* 8b */ { "STY",   ASM_ADDR_MODE_ABSOLUTE_X },
    ...
    /* 92 */ { "STA",   ASM_ADDR_MODE_INDIRECT_Z },
    /* 93 */ { "BCC",   ASM_ADDR_MODE_RELATIVE_LONG },
    ...
    /* 9b */ { "STX",   ASM_ADDR_MODE_ABSOLUTE_Y },
    ...
    /* a3 */ { "LDZ",   ASM_ADDR_MODE_IMMEDIATE },
    ...
    /* b2 */ { "LDA",   ASM_ADDR_MODE_INDIRECT_Z },
    /* b3 */ { "BCS",   ASM_ADDR_MODE_RELATIVE_LONG },
    ...
    /* bb */ { "LDZ",   ASM_ADDR_MODE_ABSOLUTE_X },
    ...
    /* c2 */ { "CPZ",   ASM_ADDR_MODE_IMMEDIATE },
    /* c3 */ { "DEW",   ASM_ADDR_MODE_ZERO_PAGE },
    ...
    /* d2 */ { "CMP",   ASM_ADDR_MODE_INDIRECT_Z },
    /* d3 */ { "BNE",   ASM_ADDR_MODE_RELATIVE_LONG },
    /* d4 */ { "CPZ",   ASM_ADDR_MODE_ZERO_PAGE },
    ...
    /* db */ { "PHZ",   ASM_ADDR_MODE_IMPLIED },
    /* dc */ { "CPZ",   ASM_ADDR_MODE_ABSOLUTE },
    ...
    /* e2 */ { "LDA",   ASM_ADDR_MODE_STACK_RELATIVE_Y },
    /* e3 */ { "INW",   ASM_ADDR_MODE_ZERO_PAGE },
    ...
    /* f2 */ { "SBC",   ASM_ADDR_MODE_INDIRECT_Z },
    /* f3 */ { "BEQ",   ASM_ADDR_MODE_RELATIVE_LONG },
    /* f4 */ { "PHW",   ASM_ADDR_MODE_IMMEDIATE_16 },
    ...
    /* fb */ { "PLZ",   ASM_ADDR_MODE_IMPLIED },
    /* fc */ { "PHW",   ASM_ADDR_MODE_ABSOLUTE },
...
void asm65CE02_init(monitor_cpu_type_t *monitor_cpu_type)
{
    monitor_cpu_type->cpu_type = CPU_65CE02;
    ...
    mon_assemble65CE02_init(monitor_cpu_type);
    mon_register65CE02_init(monitor_cpu_type);
}
