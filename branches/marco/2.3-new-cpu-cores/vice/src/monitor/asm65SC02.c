/*
 * asm65SC02.c - 65SC02 Assembler-related utility functions.
 *
 * Written by
...
void asm65SC02_init(monitor_cpu_type_t *monitor_cpu_type)
{
    monitor_cpu_type->cpu_type = CPU_65SC02;
    ...
    mon_assemble65SC02_init(monitor_cpu_type);
    mon_register65SC02_init(monitor_cpu_type);
}
