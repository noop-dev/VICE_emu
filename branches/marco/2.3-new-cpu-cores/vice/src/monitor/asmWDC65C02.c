/*
 * asmWDC65C02.c - WDC65C02 Assembler-related utility functions.
 *
 * Written by
...
void asmWDC65C02_init(monitor_cpu_type_t *monitor_cpu_type)
{
    monitor_cpu_type->cpu_type = CPU_WDC65C02;
    ...
    mon_assembleWDC65C02_init(monitor_cpu_type);
    mon_registerWDC65C02_init(monitor_cpu_type);
}
