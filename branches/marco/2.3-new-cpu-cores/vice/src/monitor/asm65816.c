...
static const int addr_mode_size[] = {
    ...
    0, /* ASM_ADDR_MODE_ZERO_PAGE_BIT3_RELATIVE */
    0, /* ASM_ADDR_MODE_ZERO_PAGE_BIT4_RELATIVE */
    0, /* ASM_ADDR_MODE_ZERO_PAGE_BIT5_RELATIVE */
    0, /* ASM_ADDR_MODE_ZERO_PAGE_BIT6_RELATIVE */
    0, /* ASM_ADDR_MODE_ZERO_PAGE_BIT7_RELATIVE */
    0, /* ASM_ADDR_MODE_ZERO_PAGE_BIT0 */
    0, /* ASM_ADDR_MODE_ZERO_PAGE_BIT1 */
    0, /* ASM_ADDR_MODE_ZERO_PAGE_BIT2 */
    0, /* ASM_ADDR_MODE_ZERO_PAGE_BIT3 */
    0, /* ASM_ADDR_MODE_ZERO_PAGE_BIT4 */
    0, /* ASM_ADDR_MODE_ZERO_PAGE_BIT5 */
    0, /* ASM_ADDR_MODE_ZERO_PAGE_BIT6 */
    0, /* ASM_ADDR_MODE_ZERO_PAGE_BIT7 */
    0, /* ASM_ADDR_MODE_INDIRECT_Z */
    3, /* ASM_ADDR_MODE_RELATIVE_LONG */
    0, /* ASM_ADDR_MODE_IMMEDIATE_24 */
