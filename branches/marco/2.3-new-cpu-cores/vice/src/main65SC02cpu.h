/*
 * main65SC02cpu.h - Emulation of the main 65SC02 processor.
 *
 * Written by
...
#ifndef VICE_MAIN65SC02CPU_H
#define VICE_MAIN65SC02CPU_H
...
struct mos65SC02_regs_s;
extern struct mos65SC02_regs_s maincpu_regs;
