...
extern void ui_open_canvas_window(struct video_canvas_s *canvas, float pixel_aspect_ratio);
...
extern void ui_resize_canvas_window(struct video_canvas_s *canvas, float pixel_aspect_ratio);
