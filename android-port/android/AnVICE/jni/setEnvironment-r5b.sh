...
#locnet
NDK="e:/Develop/Android/android-ndk-r5b"
...
#locnet
LOCAL_PATH=c:/Projects/Eclipse/C64/AnC64/jni

APP_MODULES=`grep 'APP_MODULES [:][=]' $LOCAL_PATH/Application.mk | sed 's@.*[=]\(.*\)@\1@'`
APP_AVAILABLE_STATIC_LIBS=`grep 'APP_AVAILABLE_STATIC_LIBS [:][=]' $LOCAL_PATH/Application.mk | sed 's@.*[=]\(.*\)@\1@'`
APP_SHARED_LIBS=$(
...
$LOCAL_PATH/../obj/local/armeabi/libSDL.so \
