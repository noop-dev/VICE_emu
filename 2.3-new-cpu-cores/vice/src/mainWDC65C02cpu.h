/*
 * mainWDC65C02cpu.h - Emulation of the main WDC65C02 processor.
 *
 * Written by
...
#ifndef VICE_MAINWDC65C02CPU_H
#define VICE_MAINWDC65C02CPU_H
...
struct WDC65C02_regs_s;
extern struct WDC65C02_regs_s maincpu_regs;
