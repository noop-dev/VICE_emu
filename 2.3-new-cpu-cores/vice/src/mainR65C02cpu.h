/*
 * mainR65C02cpu.h - Emulation of the main R65C02 processor.
 *
 * Written by
...
#ifndef VICE_MAINR65C02CPU_H
#define VICE_MAINR65C02CPU_H
...
struct R65C02_regs_s;
extern struct R65C02_regs_s maincpu_regs;
